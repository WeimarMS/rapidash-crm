...
// Segmented control compacto y discreto. Fijo arriba a la derecha; en móvil se
// posiciona dentro de la barra superior (h-14) y en desktop flota sobre el
// contenido. Refleja el idioma activo desde el LanguageContext.
...
function LanguageToggle() {
  ...
  return (
    <div
      className="fixed top-3 right-3 lg:top-4 lg:right-4 z-50 inline-flex items-center gap-1 rounded-full bg-white/95 backdrop-blur border border-slate-200 shadow-sm p-1"
      role="group"
